...
let ApiService = class ApiService {
    ...
    postQuestion(question) {
        this.http.post('https://localhost:44355/api/questions', question).subscribe(res => {
            console.log(res);
        });
    }
    putQuestion(question) {
        this.http.put(`https://localhost:44355/api/questions/${question.id}`, question).subscribe(res => {
            console.log(res);
        });
    }
    postQuiz(quiz) {
        this.http.post('https://localhost:44355/api/quizzes', quiz).subscribe(res => {
            console.log(res);
        });
    }
    putQuiz(quiz) {
        this.http.put(`https://localhost:44355/api/quizzes/${quiz.id}`, quiz).subscribe(res => {
            console.log(res);
        });
    }
...
let AuthService = class AuthService {
    ...
    register(credentials) {
        this.http.post(`http://localhost:44355/api/account`, credentials).subscribe(res => {
